...
document.getElementById("bq").onclick = function() {
  ...
  var { value: jawaban } = await swals.fire({
    title: 'Isi pesannya iyah wkwk &#128073;&#128072;', input: 'text', allowOutsideClick: false, showCancelButton: false,
  });
  if(jawaban && jawaban.length < 100){
    window.jawaban = jawaban;
    pesanwhatsapp = jawaban;
    await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp, ya!', 'success');
    window.location = "https://api.whatsapp.com/send?phone=6281210006217&text=" + pesanwhatsapp;
    tombol();
  } else {
    await swals.fire('Ups!', 'Jawaban tidak boleh kosong.. ya!');jawab();
  }
}